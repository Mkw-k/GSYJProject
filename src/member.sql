...
INSERT INTO BBS (SEQ, MYID, TITLE, MYCONTENT, WDATE, FILENAME, VCOUNT, DEL)
VALUES(SEQ_BBS.NEXTVAL, 'gd', '파일업로드', '가나다', SYSDATE, '1203058382', 2, 0);
...
MYCONTENT VARCHAR2(500) NOT NULL,	 --내용
WDATE DATE NOT NULL, 			 --작성일
LINK VARCHAR2(100) NOT NULL,	 --동영상 IMBEDED 링크 
DEL NUMBER NOT NULL, 		 	 --삭제여부
