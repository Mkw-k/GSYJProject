...
<table class="table table-bordered" style="width: 1000px">
	<col width="150px">
		<tr>
			<th>부모글제목</th>
			<td><%=dto.getRdtitle() %></td>
		</tr>
		
		<tr>
			<th>내용</th>
			<td><textarea rows="15" cols="100" readonly="readonly"><%=dto.getRdmycontent() %></textarea></td>
		</tr>
		
		<tr>
			<th>작성일</th>
			<td><%=dto.getRdwdate() %></td>
		</tr>
	
		<tr>
			<th>이미지</th>
			<td><img alt="" src="./upload/<%=dto.getRdate() %>"style="max-width: 600px; max-height: 600px;">
			</td>
		</tr>
...
<br>
	...
	<button type="button" onclick="javascript:history.back(-1)">글목록</button>
